# USAGE: Start lithe-service as you usually would
...
from lithe import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="Lithe address to optimize", required=True)
